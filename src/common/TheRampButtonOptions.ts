...
export const LIGHT_SURFACE_TEXT_FILL = TheRampColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link TheRampColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: TheRampColors.controlSurfaceColorProperty,
  listFill: TheRampColors.controlSurfaceColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: TheRampColors.textColorProperty },
  },
